...
// import styles
import { AuthContainer, ContainCenter } from "../../styles/AuthStyles";
...
export const Register = () => {
  ...
  <ContainCenter>
      ...
      <div className="field">
        ...
        <input 
        id="logemail" placeholder="Email" className="input-field" name="logemail" type="email"
        value={email}
      ...
      <div className="field">
        ...
        <input 
        id="logpass" placeholder="Password" className="input-field" 
        type="password"
        value={password}
